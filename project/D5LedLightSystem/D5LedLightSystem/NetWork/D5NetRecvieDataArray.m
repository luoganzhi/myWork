...
- (void)addUdpData:(NSData *)data from:(NSString *)IP {
    @autoreleasepool {
        ...
        [dic setObject:[NSNumber numberWithInt:data_from_udp] forKey:DATA_RECEIVE_TYPE];
        [dic setObject:IP forKey:DATA_FROM_IP];
        [dic setObject:data forKey:DATA_RECEIVE];
...
- (void)addTcpData:(NSData *)data{
    @autoreleasepool {
        NSMutableDictionary *dic = [[NSMutableDictionary alloc] init];
        [dic setObject:[NSNumber numberWithInt:data_from_tcp] forKey:DATA_RECEIVE_TYPE];
        [dic setObject:data forKey:DATA_RECEIVE];
        [self.dataArray addObject:dic];
    }
}
