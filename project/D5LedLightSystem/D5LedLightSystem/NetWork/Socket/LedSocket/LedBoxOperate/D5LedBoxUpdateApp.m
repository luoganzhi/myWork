...
#import "D5LedBoxUpdateApp.h"

@implementation D5LedBoxUpdateApp

- (void)ledBoxUpdateApp:(NSString *)url {
    @autoreleasepool {
        LedHeader *header = [self headerForCmd:Cmd_Box_Operate withSubCmd:SubCmd_Box_Update];
        
        NSData *body = [url dataUsingEncoding:NSUTF8StringEncoding];        
...
//            @autoreleasepool {
//                if (obj && [obj respondsToSelector:@selector(ledBoxUpdateAppReturn:)]) {
//                    [obj ledBoxUpdateAppReturn:status];
//                }
//            }
//        }];
    }
