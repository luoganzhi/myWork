...
@property (strong, nonatomic) NSMutableArray * localCmdArray,* remoteCmdArray;
@property (strong, nonatomic) dispatch_semaphore_t remoteSem,localSem;
@property (assign,nonatomic) BOOL localSending,remoteSending;
@property (strong, nonatomic) dispatch_group_t goup;
