...
- (void)commonInit {
    ...
    _contentColor = isLegacy ? [UIColor whiteColor] : WHITE_COLOR;
...
- (void)setupViews {
    ...
    bezelView.backgroundColor = [UIColor colorWithWhite:0 alpha:1.0f];
...
- (void)updateConstraints {
    ...
    if (self.location == MBProgressHUDLocationTop) {
        [centeringConstraints addObject:[NSLayoutConstraint constraintWithItem:bezel attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeTop multiplier:1.f constant:offset.y]];
    } else if (self.location == MBProgressHUDLocationBottom) {
        [centeringConstraints addObject:[NSLayoutConstraint constraintWithItem:bezel attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeBottom multiplier:1.f constant:offset.y]];
    } else {
